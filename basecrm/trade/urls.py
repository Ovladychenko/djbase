...
urlpatterns = [
    ...
    path('reports_salary_managers_сomparison/', reports_salary_managers_сomparison,
         name='reports_salary_managers_сomparison'),
    ...
    # documents
    path('documents_sales', documents_sales, name='documents_sales')
